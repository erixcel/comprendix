import { GamePuzzle } from "../../model/configuration";

export const game_puzzle_1: GamePuzzle = {
  type: "puzzle",
...
export const game_puzzle_2: GamePuzzle = {
  type: "puzzle",
...
export const game_puzzle_3: GamePuzzle = {
  type: "puzzle",
